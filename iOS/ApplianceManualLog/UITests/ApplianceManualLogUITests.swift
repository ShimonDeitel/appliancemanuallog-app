...
final class ApplianceManualLogUITests: XCTestCase {
    ...
    func testAddItemFlow() {
        ...
        let field1 = app.textFields["fieldAppliance"]
        XCTAssertTrue(field1.waitForExistence(timeout: 2))
        field1.tap()
        field1.typeText("Test Appliance")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["Test Appliance"].waitForExistence(timeout: 2))
    }
